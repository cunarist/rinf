...
All platforms available with Flutter are [tested](https://github.com/cunarist/rust-in-flutter/actions/workflows/build-test.yaml?query=branch%3Amain) and supported. Also, challenging build settings are automatically handled by this package.
