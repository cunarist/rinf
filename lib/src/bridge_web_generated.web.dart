...
class BridgeWebPlatform extends FlutterRustBridgeBase<BridgeWebWire>
  ...
  BridgeWebPlatform(FutureOr<WasmModule> dylib) : super(BridgeWebWire(dylib)) {
...
@JS('wasm_bindgen')
external BridgeWebWasmModule get wasmModule;

@JS()
@anonymous
class BridgeWebWasmModule implements WasmModule {
  external Object /* Promise */ call([String? moduleName]);
  external BridgeWebWasmModule bind(dynamic thisArg, String moduleName);
...
class BridgeWebWire extends FlutterRustBridgeWasmWireBase<BridgeWebWasmModule> {
  BridgeWebWire(FutureOr<WasmModule> module)
      : super(WasmModule.cast<BridgeWebWasmModule>(module));
