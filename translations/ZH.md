...
这部分假设您已经在系统上安装了[Flutter SDK](https://docs.flutter.dev/get-started/install)，并使用`flutter create`命令创建了一个 Flutter 项目。请将此 Flutter 项目的文件夹作为您的终端工作目录。如果您还没有 Flutter 项目，请按照这个很棒的教程创建一个。
